...
// Descrição: Declara Terms 1 D no contexto de OneDimensional / Term.
...
// Representa o termo de difusao que sera somado a uma equacao 1D.
class DiffusionTerm1D final {
public:
    // Cria um objeto DiffusionTerm1D com os dados fornecidos.
...
// Representa o termo de adveccao que sera somado a uma equacao 1D.
class AdvectionTerm1D final {
public:
    // Cria um objeto AdvectionTerm1D com os dados fornecidos.
...
// Representa o termo fonte que sera somado a uma equacao 1D.
class SourceTerm1D final {
public:
    // Cria um objeto SourceTerm1D com os dados fornecidos.
...
// Representa os termos algebricos introduzidos pelas condicoes de contorno.
class BoundaryTerm1D final {
public:
    // Cria um objeto BoundaryTerm1D com os dados fornecidos.
