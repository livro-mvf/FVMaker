...
// na geração de malhas unidimensionais aleatórias.
//
// Este programa implementa geração de malhas com distribuição aleatória
// para testes de robustez de métodos numéricos.
//
 ...
 * 
 * Este programa demonstra o uso de técnicas modernas de C++ para
 * gerar uma malha unidimensional com distribuição aleatória.
 * 
